...
final class MainWindowController: NSWindowController {
    ...
    func addArrayPerson() {
        ...
        arrayPerson.append(Person(firstName: "John", lastName: "Martin", dateOfBirth: Date(), age: 25, department: "Finance", country: "Mexico", isBool: false))
        ...
        arrayPerson.append(Person(firstName: "John", lastName: "Doe", dateOfBirth: Date(), age: 27, department: "Finance", country: "United States", isBool: true))
